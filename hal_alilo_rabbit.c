...
OSStatus hal_alilo_rabbit_init(void)
{
    ...
    // audio_service_sound_remind_start(&result, 4);  //請長按與我對話吧
    ...
    // audio_service_sound_remind_start(&result, 9);  //還剩25%電量 電量快不足了
    // audio_service_sound_remind_start(&result, 10); //還剩%5電量 快幫我充充電吧
    // audio_service_sound_remind_start(&result, 11); //微信消息聲音 “嗚”
    // audio_service_sound_remind_start(&result, 12); //門鈴響聲 “頂燈爾”
    // audio_service_sound_remind_start(&result, 13); //“噔噔”聲

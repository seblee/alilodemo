...
extern mico_semaphore_t urlPalyStreamStop_Sem;
...
extern OSStatus hal_url_fileDownload_pause(void);
extern OSStatus hal_url_fileDownload_continue(void);
extern OSStatus hal_url_fileDownload_stop(void);

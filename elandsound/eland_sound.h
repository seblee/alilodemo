...
#define SOUND_FILE_WEATHER_B (uint8_t)0X06
#define SOUND_FILE_WEATHER_C (uint8_t)0X07
#define SOUND_FILE_WEATHER_D (uint8_t)0X08
#define SOUND_FILE_WEATHER_E (uint8_t)0X09
#define SOUND_FILE_WEATHER_F (uint8_t)0X0a
